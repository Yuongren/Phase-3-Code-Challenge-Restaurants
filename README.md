...
## Project Setup
  ...
  First clone the repository: git clone --  repository url --
  Then open the cloned repository: cd -- cloned repository -- 
  create virtual environment by running pipenv shell and then install dependencies by running pipenv install
  To run the tests by typing pytest on your command line.
